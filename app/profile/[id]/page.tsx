      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <p className="font-bold text-center">{`${parseFloat(userData.balance_sol).toLocaleString(undefined, { minimumFractionDigits: 6, maximumFractionDigits: 6 })}` }</p>
          ...
          <Card>
            ...
            <CardContent>
              <p className="font-bold text-center">{`${parseFloat(userData.balance_gamer).toLocaleString(undefined, { minimumFractionDigits: 6, maximumFractionDigits: 6 })}`}</p>
              <div className="flex justify-between mt-4">
          ...
          <Card>
            ...
            <CardContent>
              <p className="font-bold text-center">{testerEarnings.toFixed(2)}</p>
            </CardContent>
          </Card>
        </div>
