...
export function SwapDesktop() {
  ...
  const calculateFee = (amount: number) => {
    return amount * (MOCK_RATES.fee / 100)
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <Card className="bg-[#111] border-[#333] shadow-lg">
              <CardHeader>
                <CardTitle className="text-2xl font-bold text-white">Swap Tokens</CardTitle>
                      ...
                      <div className="text-sm text-white flex items-center">
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent>Rates are updated every 5 minutes</TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      </div>
                    </div>
