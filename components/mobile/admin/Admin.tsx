    ...
    return (
      <div className="px-4 py-6">
        <div className="flex flex-col items-center justify-center min-h-[60vh]">
          <Card className="w-full bg-black/60 border border-purple-500/30 shadow-lg shadow-purple-500/20">
            <CardHeader className="text-center">
              <CardTitle className="text-xl font-bold text-white">Admin Access Required</CardTitle>
    ...
    <div className="px-4 py-6">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        ...
        <Tabs defaultValue="platform" className="space-y-6">
          <TabsList className="grid grid-cols-3 gap-1 bg-black/40 p-1 rounded-lg border border-purple-500/20">
            <TabsTrigger
              value="platform"
            ...
            <div className="space-y-4">
              <Card className="bg-black/60 border border-purple-500/30 shadow-lg shadow-purple-500/10">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-3 mt-4">
                    <Label htmlFor="pay-wallet-mobile" className="text-gray-300">
                      Pay Wallet
                    </Label>
                    <div className="flex items-center space-x-2">
                      <Input
                        id="pay-wallet-mobile"
                        type="text"
                        value={payWallet}
                  ...
                  <div className="space-y-3 mt-4">
                    <Label htmlFor="withdraw-amount-mobile" className="text-gray-300">
                      Withdraw SOL
                    </Label>
                    <div className="flex items-center space-x-2">
                      <Input
                        id="withdraw-amount-mobile"
                        type="text"
              ...
              <Card className="bg-black/60 border border-purple-500/30 shadow-lg shadow-purple-500/10">
                ...
                <CardContent className="space-y-4">
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="fees" className="border-purple-500/30">
                      <AccordionTrigger className="text-white hover:text-purple-300">Fee Settings</AccordionTrigger>
                      <AccordionContent>
                        <div className="space-y-3 pt-2">
                          <div className="space-y-2">
                            <Label htmlFor="dev-fee-mobile" className="text-gray-300">
                              Developer Fee %
                            </Label>
                            <Input
                              id="dev-fee-mobile"
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="platform-fee-mobile" className="text-gray-300">
                              Platform Fee %
                            </Label>
                            <Input
                              id="platform-fee-mobile"
                              type="number"
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="top-player-fee-mobile" className="text-gray-300">
                              Top Player %
                            </Label>
                            <Input
                              id="top-player-fee-mobile"
                              type="number"
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="boost-fee-mobile" className="text-gray-300">
                              Boost Fee (credits)
                            </Label>
                            <Input
                              id="boost-fee-mobile"
                    ...
                    <AccordionItem value="tokens" className="border-purple-500/30">
                      <AccordionTrigger className="text-white hover:text-purple-300">
                        GAMEr Token Settings
                      </AccordionTrigger>
                      <AccordionContent>
                        <div className="space-y-3 pt-2">
                          <div className="space-y-2">
                            <Label htmlFor="min-tokens-arcade-mobile" className="text-gray-300">
                              Min Tokens for Arcade
                            </Label>
                            <Input
                              id="min-tokens-arcade-mobile"
                              type="number"
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="min-tokens-esports-mobile" className="text-gray-300">
                              Min Tokens for Esports
                            </Label>
                            <Input
                              id="min-tokens-esports-mobile"
                              type="number"
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="min-tokens-tournaments-mobile" className="text-gray-300">
                              Min Tokens for Tournaments
                            </Label>
                            <Input
                              id="min-tokens-tournaments-mobile"
                              type="number"
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="min-tokens-grabbit-mobile" className="text-gray-300">
                              Min Tokens for Grabbit
                            </Label>
                            <Input
                              id="min-tokens-grabbit-mobile"
                              type="number"
              ...
              {isSuperAdmin && (
                <Card className="bg-black/60 border border-purple-500/30 shadow-lg shadow-purple-500/10">
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="new-admin-address-mobile" className="text-gray-300">
                        New Admin Solana Address
                      </Label>
                      <Input
                        id="new-admin-address-mobile"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="new-admin-role-mobile" className="text-gray-300">
                        New Admin Role
                      </Label>
                      <select
                        id="new-admin-role-mobile"
                        value={newAdminRole}
                ...
                <CardContent>
                  <div className="space-y-3">
                    {approvedTokens.map((token: any) => (
                      <Card key={token.id} className="bg-black/40 border border-purple-500/20">
                        <CardContent className="p-3">
                          <div className="flex justify-between items-center">
                            <div>
                              ...
                              <p className="text-xs text-gray-400 truncate max-w-[200px]">{token.address}</p>
                            </div>
                            <Badge
                              variant="outline"
                              className={
                    ...
                    {approvedTokens.length === 0 && (
                      <div className="text-center py-4 text-gray-400">No approved tokens found</div>
                    )}
                  </div>
                </CardContent>
              </Card>
          ...
          <TabsContent value="games">
              ...
              <CardContent>
                <div className="space-y-3">
                  {gameStats.map((game: any) => (
                    <Card key={game.id} className="bg-black/40 border border-purple-500/20">
                      <CardContent className="p-3">
                        <div className="flex justify-between items-center">
                        ...
                        <div className="grid grid-cols-2 gap-2 mt-2 text-sm">
                          <div className="text-gray-400">
                            Plays: <span className="text-white">{game.play_count}</span>
                          </div>
                          <div className="text-gray-400">
                            Boosts: <span className="text-white">{game.boost_count}</span>
                          </div>
                          <div className="text-gray-400">
                            Upvotes: <span className="text-white">{game.upvotes}</span>
                          </div>
                          <div className="text-gray-400">
                            Downvotes: <span className="text-white">{game.downvotes}</span>
                          </div>
                        </div>
                  ...
                  {gameStats.length === 0 && <div className="text-center py-4 text-gray-400">No games found</div>}
                </div>
              </CardContent>
            </Card>
            ...
            <Dialog open={showGameDialog} onOpenChange={setShowGameDialog}>
              <DialogContent className="bg-black/90 border border-purple-500/30 text-white">
                <DialogHeader>
                  <DialogTitle className="text-xl text-white">Manage Game</DialogTitle>
                  <DialogDescription className="text-gray-400">{selectedGame?.title}</DialogDescription>
                </DialogHeader>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-white">{selectedGame.is_paused ? "Paused" : "Active"}</p>
                      </div>
                      <div>
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="game-fee" className="text-gray-300">
                        Game Fee
                      </Label>
                      <Input
                        id="game-fee"
                        ...
                        // onChange={(e) => setSelectedGame({...selectedGame, fee: Number(e.target.value)})}
                        className="bg-black/40 border-purple-500/30 text-white"
                      />
                    </div>
                  </div>
                ...
                <DialogFooter className="flex flex-col sm:flex-row gap-2">
                  <Button
                    onClick={() => handleToggleGamePause(selectedGame?.id)}
                    className={
                      selectedGame?.is_paused
                  ...
                  <Button
                    onClick={() => handleUpdateGameFees(selectedGame?.id)}
                    className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white"
                  >
                    <RefreshCw className="mr-2 h-4 w-4" />
                    Update Fees
                ...
                {searchResults.length > 0 ? (
                  <div className="space-y-3">
                    {searchResults.map((user: any) => (
                      <Card key={user.wallet} className="bg-black/40 border border-purple-500/20">
                        <CardContent className="p-3">
                          <div className="flex justify-between items-center">
                          ...
                          <p className="text-xs text-gray-400 truncate mt-1">{user.wallet}</p>
              ...
              <CardContent>
                <div className="space-y-3">
                  {supportTickets.map((ticket: any) => (
                    <Card key={ticket.id} className="bg-black/40 border border-purple-500/20">
                      <CardContent className="p-3">
                        <div className="flex justify-between items-center">
                  ...
                  {supportTickets.length === 0 && (
                    <div className="text-center py-4 text-gray-400">No support tickets found</div>
                  )}
                </div>
              </CardContent>
            </Card>
                ...
                {selectedTicket && (
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-white break-all text-xs">{selectedTicket.user_id}</p>
                    </div>
                    ...
                    {selectedTicket.transaction_id && (
                      <div>
                        ...
                        <p className="text-white break-all text-xs">{selectedTicket.transaction_id}</p>
                      </div>
                    )}

                    <div>
                      <p className="text-gray-400 text-sm">Message</p>
                      <div className="mt-1 p-3 bg-purple-900/10 rounded-md text-white text-sm">
                    ...
                    {selectedTicket.status === "open" ? (
                      <div className="space-y-2">
                        <Label htmlFor="response-mobile" className="text-gray-300">
                          Response
                        </Label>
                        <Textarea
                          id="response-mobile"
              ...
              <CardContent>
                <div className="space-y-3">
                  {products.map((product: any) => (
                    <Card key={product.id} className="bg-black/40 border border-purple-500/20">
                      <CardContent className="p-3">
                        <div className="flex items-center space-x-3">
                          <div className="w-12 h-12 rounded-md overflow-hidden bg-purple-900/20 flex-shrink-0">
                            <img
                  ...
                  {products.length === 0 && <div className="text-center py-4 text-gray-400">No products found</div>}
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="wallets">
            <Card className="bg-black/60 border border-purple-500/30 shadow-lg shadow-purple-500/10">
              ...
              <CardContent>
                <div className="space-y-3">
                  {wallets.map((wallet) => (
                    <Card key={wallet.id} className="bg-black/40 border border-purple-500/20">
                      <CardContent className="p-3">
                        <div className="flex justify-between items-center">
                        ...
                        {wallet.game_id && <p className="text-xs text-gray-400 mt-1">Game ID: {wallet.game_id}</p>}
                        <div className="mt-3 flex justify-between items-center">
                          <p className="text-xs text-gray-400">{new Date(wallet.created_at).toLocaleDateString()}</p>
                          <Button
                            variant="outline"
                            size="sm"
                            className="border-purple-500/30 text-purple-400 hover:bg-purple-900/20"
                  ...
                  {wallets.length === 0 && <div className="text-center py-4 text-gray-400">No wallets found</div>}
                </div>
              </CardContent>
            </Card>
          </TabsContent>
        ...
        <Dialog open={showTokenDialog} onOpenChange={setShowTokenDialog}>
          <DialogContent className="bg-black/90 border border-purple-500/30 text-white">
            <DialogHeader>
              <DialogTitle className="text-xl text-white">Add New Token</DialogTitle>
              <DialogDescription className="text-gray-400">
                Add a new token to the approved tokens list
              </DialogDescription>
            </DialogHeader>

            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="new-token-name-dialog" className="text-gray-300">
                  Token Name
                </Label>
                <Input
                  id="new-token-name-dialog"
                  value={newTokenName}
              ...
              <div className="space-y-2">
                <Label htmlFor="new-token-ticker-dialog" className="text-gray-300">
                  Token Ticker
                </Label>
                <Input
                  id="new-token-ticker-dialog"
              ...
              <div className="space-y-2">
                <Label htmlFor="new-token-address-dialog" className="text-gray-300">
                  Token Address
                </Label>
                <Input
                  id="new-token-address-dialog"
            ...
            <DialogFooter>
              <Button
                ...
                disabled={!newTokenName || !newTokenTicker || !newTokenAddress}
                className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white"
              >
                <Plus className="mr-2 h-4 w-4" />
                Add Token
