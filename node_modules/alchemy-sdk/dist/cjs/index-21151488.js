...
(function (HistoricalPriceInterval) {
    /** 5-minute intervals */
    HistoricalPriceInterval["FIVE_MINUTE"] = "5m";
    /** 1-hour intervals */
    HistoricalPriceInterval["ONE_HOUR"] = "1h";
    /** 1-day intervals */
    HistoricalPriceInterval["ONE_DAY"] = "1d";
    ...
    getProvider() {
        if (!this._baseAlchemyProvider) {
            this._baseAlchemyProvider = (() => __awaiter$1(this, void 0, void 0, function* () {
                const { AlchemyProvider } = yield Promise.resolve().then(function () { return require('./alchemy-provider-c001c0d6.js'); });
    ...
    getWebSocketProvider() {
        if (!this._baseAlchemyWssProvider) {
            this._baseAlchemyWssProvider = (() => __awaiter$1(this, void 0, void 0, function* () {
                const { AlchemyWebSocketProvider } = yield Promise.resolve().then(function () { return require('./alchemy-websocket-provider-1de9cb2a.js'); });
...
//# sourceMappingURL=index-21151488.js.map
