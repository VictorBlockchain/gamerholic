...
import { AbortableParam, AnyError, AsyncResultWithTypedError, Descriptor, Logger, PathPublic, ResultWithTypedError, Session, Success } from '../types';
...
export declare abstract class AbstractTransport extends TransportEmitter {
    abstract readonly name: 'BridgeTransport' | 'NodeUsbTransport' | 'WebUsbTransport' | 'UdpTransport' | 'NativeUsbTransport' | 'BluetoothTransport';
    abstract readonly apiType: TransportApiType;
    isOutdated: boolean;
    version: string;
