...
import type { UserOperationRequest, UserOperationRequest_v7 } from "../types.js";
...
export declare function packPaymasterData({ paymaster, paymasterVerificationGasLimit, paymasterPostOpGasLimit, paymasterData, }: Pick<UserOperationRequest_v7, "paymaster" | "paymasterVerificationGasLimit" | "paymasterPostOpGasLimit" | "paymasterData">): Hex;
export declare function unpackAccountGasLimits(accountGasLimits: string): {
    verificationGasLimit: number;
    callGasLimit: number;
};
//# sourceMappingURL=0.7.d.ts.map