const STRINGS = {
    "en-US": {
        ...
        addPasskey: {
            ...
            simplerLoginDescription: "Create a passkey to enable quick and easy login with Face ID or Touch ID.",
            enhancedSecurityTitle: "Enhanced security",
            enhancedSecurityDescription: "Prevent phishing and theft by registering a passkey with your device.",
        },
        loadingEmail: {
        ...
        error: {
            ...
            connection: {
                ...
                passkeyBody: "Passkey request timed out or canceled by the agent. You may have to use another method to register a passkey for your account.",
