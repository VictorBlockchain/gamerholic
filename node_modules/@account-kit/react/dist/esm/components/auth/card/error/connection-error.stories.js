...
export const OAuthGoogle = {
    args: {
        ...
        icon: _jsx(OAuthConnectionFailed, { provider: "google" }),
...
export const OAuthFacebook = {
    args: {
        ...
        bodyText: ls.error.connection.oauthBody,
        icon: _jsx(OAuthConnectionFailed, { provider: "facebook" }),
        handleUseAnotherMethod: () => { },
    },
};
export const EOAWalletConnect = {
    args: {
        headerText: ls.error.connection.walletTitle,
        bodyText: ls.error.connection.walletBody,
        icon: _jsx(WalletIcon, { connector: WALLET_CONNECT }),
        handleUseAnotherMethod: () => { },
    },
};
export const EOAMetamask = {
    args: {
        headerText: `${ls.error.connection.walletTitle} MetaMask`,
        bodyText: ls.error.connection.walletBody,
        icon: (_jsx(WalletIcon, { connector: {
...
//# sourceMappingURL=connection-error.stories.js.map