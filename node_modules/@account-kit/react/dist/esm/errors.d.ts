 ...
 */
export declare class NoAlchemyAccountContextError extends BaseError {
    /**
 ...
 * @param hookName The name of the hook.
 */
export declare class ClientUndefinedHookError extends BaseError {
    /**
 ...
 */
export declare class MissingUiConfigError extends BaseError {
    /**
 ...
 */
export declare class UnsupportedEOAActionError extends BaseError {
    /**
