...
export function useSendUserOperation(params) {
    ...
    return {
        sendUserOperation: ReactLogger.profiled("sendUserOperation", sendUserOperation),
        sendUserOperationAsync: ReactLogger.profiled("sendUserOperationAsync", sendUserOperationAsync),
