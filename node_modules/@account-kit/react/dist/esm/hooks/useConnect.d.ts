...
import { type UseConnectParameters, type UseConnectReturnType } from "wagmi";
/**
 ...
 * ```
 */
export declare const useConnect: (params?: UseConnectParameters<Config>["mutation"]) => UseConnectReturnType<Config>;
