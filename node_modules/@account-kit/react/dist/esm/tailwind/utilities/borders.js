...
export const borderRadiusUtilities = {
    radius: (value) => ({
        borderRadius: typeof value === "string" ? value : getScaledBorderRadius(value),
    }),
    "radius-t": (value) => ({
        borderTopLeftRadius: typeof value === "string" ? value : getScaledBorderRadius(value),
        borderTopRightRadius: typeof value === "string" ? value : getScaledBorderRadius(value),
    }),
};
