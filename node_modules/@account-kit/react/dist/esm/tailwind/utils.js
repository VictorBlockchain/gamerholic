 ...
 */
export const createColorSet = (light, dark) => ({
    light,
    dark,
});
/**
 ...
 */
export const apply = (source, target) => {
    if (!target)
        return source;
 ...
 */
export const getColorVariableName = (name) => {
 ...
 */
export const getBorderRadiusBaseVariableName = () => {
 ...
 */
export const getScaledBorderRadius = (scale) => {
