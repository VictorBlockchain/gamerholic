...
export function Spinner({ className }) {
    return (_jsxs(_Fragment, { children: [_jsx("img", { src: SpinnerLightModeBase64, alt: "Loading", className: `dark:hidden animate-spin ${className ?? ""}` }), _jsx("img", { src: SpinnerDarkModeBase64, alt: "Loading", className: `hidden animate-spin dark:inline ${className ?? ""}` })] }));
}
