 ...
 */
export const watchBundlerClient = (config) => (onChange) => {
    return config.store.subscribe(({ bundlerClient }) => bundlerClient, onChange, {
        equalityFn(a, b) {
            return a.chain.id === b.chain.id;
        },
    });
};
//# sourceMappingURL=watchBundlerClient.js.map