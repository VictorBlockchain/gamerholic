...
export async function disconnect(config) {
    ...
    config.store.setState((state) => ({
        signerStatus: convertSignerStatusToState(AlchemySignerStatus.DISCONNECTED, state.signerStatus.error),
    }));
}
...
const clearWalletConnectStore = () => {
    ...
    dbOpenRequest.onsuccess = () => {
        ...
        try {
            ...
            console.error("Error clearing Wallet Connect DB. Cannot clear store.", error);
        }
    };
