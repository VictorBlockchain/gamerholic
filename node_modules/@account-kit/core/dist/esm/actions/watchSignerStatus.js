 ...
 */
export const watchSignerStatus = (config) => (onChange) => {
    return config.store.subscribe(({ signerStatus }) => signerStatus, onChange, { equalityFn: (a, b) => a.status === b.status && a.error === b.error });
};
//# sourceMappingURL=watchSignerStatus.js.map