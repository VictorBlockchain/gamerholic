...
import { isModularV2AccountParams, } from "./createAccount.js";
 ...
 */
export const getAccount = (params, config) => {
    ...
    if (isModularV2AccountParams(params) && account?.status === "READY") {
        const accountConfig = config.store.getState().accountConfigs[chain.id]?.[params.type];
