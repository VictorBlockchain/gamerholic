...
import type { AlchemySignerParams, AlchemySignerStatus, AlchemySignerWebClient, ErrorInfo, User } from "@account-kit/signer";
...
import type { AlchemySigner, Connection, SupportedAccount, SupportedAccountTypes } from "../types";
export declare const DEFAULT_STORAGE_KEY = "alchemy-account-state";
...
export type ClientStoreConfig = {
    client: PartialBy<Exclude<AlchemySignerParams["client"], AlchemySignerWebClient>, "iframeConfig">;
...
export type StoreState = {
    ...
    smartAccountClients: {
        [chain: number]: Partial<{
            [key in SupportedAccountTypes]: GetSmartAccountClientResult<Chain, SupportedAccount<key>>;
        }>;
    };
