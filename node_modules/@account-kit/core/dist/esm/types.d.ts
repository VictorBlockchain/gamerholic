...
import type { AlchemyTransport, AlchemyTransportConfig } from "@account-kit/infra";
import type { AlchemySignerParams, AlchemySignerWebClient, AlchemyWebSigner } from "@account-kit/signer";
import type { LightAccount, LightAccountVersion, MultiOwnerLightAccount, MultiOwnerModularAccount, ModularAccountV2 } from "@account-kit/smart-contracts";
import type { CreateConnectorFn } from "@wagmi/core";
import { type Config as WagmiConfig } from "@wagmi/core";
import type { Chain } from "viem";
import type { PartialBy } from "viem/chains";
import type { ClientStoreConfig, Store, StoredState } from "./store/types";
import type { RNAlchemySignerSingleton as RNAlchemySigner, RNSignerClient } from "@account-kit/react-native-signer";
export type SupportedAccountTypes = "MultiOwnerLightAccount" | "LightAccount" | "MultiOwnerModularAccount" | "ModularAccountV2";
export type SupportedAccounts = LightAccount<AlchemySigner, LightAccountVersion<"LightAccount">> | MultiOwnerModularAccount<AlchemySigner> | MultiOwnerLightAccount<AlchemySigner, LightAccountVersion<"MultiOwnerLightAccount">> | ModularAccountV2<AlchemySigner>;
export type SupportedAccount<T extends SupportedAccountTypes> = T extends "LightAccount" ? LightAccount<AlchemySigner> : T extends "MultiOwnerModularAccount" ? MultiOwnerModularAccount<AlchemySigner> : T extends "MultiOwnerLightAccount" ? MultiOwnerLightAccount<AlchemySigner> : T extends "ModularAccountV2" ? ModularAccountV2<AlchemySigner> : never;
