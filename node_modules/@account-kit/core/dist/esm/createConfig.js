...
export const createConfig = (params) => {
    const { chain, iframeConfig, rootOrgId, rpId, sessionConfig, signerConnection, ssr, storage, connectors, oauthCallbackUrl, enablePopupOauth, _internal: { createSigner } = {}, ...connectionConfig } = params;
    const connections = [];
