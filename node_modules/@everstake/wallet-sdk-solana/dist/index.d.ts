import { Address, CompilableTransactionMessage, TransactionMessageWithBlockhashLifetime, Transaction, Blockhash, Account, ClusterUrl, IInstruction } from '@solana/web3.js';
...
declare class Solana extends Blockchain {
    ...
    constructor(network?: Network, rpc?: ClusterUrl | null);
    /**
...
export { ADDRESS_DEFAULT, type ApiResponse, Blockchain, CHAIN, type ClaimResponse, type CreateAccountResponse, DEVNET_VALIDATOR_ADDRESS, type Delegations, FILTER_DATA_SIZE, FILTER_OFFSET, MAINNET_VALIDATOR_ADDRESS, MIN_AMOUNT, Network, type Params, STAKE_ACCOUNT_V2_SIZE, STAKE_CONFIG_ACCOUNT, STAKE_HISTORY_ACCOUNT, Solana, type StakeResponse, StakeState, type UnstakeResponse, WalletSDKError, isLockupInForce, isStake, repackInstruction, stakeAccountState };
