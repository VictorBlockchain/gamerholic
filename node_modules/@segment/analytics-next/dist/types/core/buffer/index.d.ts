 ...
 */
export declare const flushRegister: (analytics: Analytics, buffer: PreInitMethodCallBuffer) => Promise<void>;
...
export type PreInitMethodParams<MethodName extends PreInitMethodName> = [...Parameters<Analytics[MethodName]>, BufferedPageContext] | Parameters<Analytics[MethodName]>;
...
export declare class PreInitMethodCallBuffer {
     ...
     */
    getAndRemove<T extends PreInitMethodName>(methodName: T): PreInitMethodCall<T>[];
...
export declare class AnalyticsBuffered implements PromiseLike<[Analytics, Context]>, AnalyticsBrowserCore {
    ...
    page: (category?: string | object | null | undefined, name?: string | object | import("@segment/analytics-core").Callback<import("@segment/analytics-core").CoreContext<import("@segment/analytics-core").CoreSegmentEvent>> | null | undefined, properties?: import("../events").Options | import("../events").EventProperties | import("@segment/analytics-core").Callback<import("@segment/analytics-core").CoreContext<import("@segment/analytics-core").CoreSegmentEvent>> | null | undefined, options?: import("../events").Options | import("@segment/analytics-core").Callback<import("@segment/analytics-core").CoreContext<import("@segment/analytics-core").CoreSegmentEvent>> | undefined, callback?: import("@segment/analytics-core").Callback<import("@segment/analytics-core").CoreContext<import("@segment/analytics-core").CoreSegmentEvent>> | undefined) => Promise<Context>;
    ...
    addSourceMiddleware: (fn: import("../..").MiddlewareFunction) => Promise<Analytics>;
    ...
    screen: (category?: string | object | null | undefined, name?: string | object | import("@segment/analytics-core").Callback<import("@segment/analytics-core").CoreContext<import("@segment/analytics-core").CoreSegmentEvent>> | null | undefined, properties?: import("../events").Options | import("../events").EventProperties | import("@segment/analytics-core").Callback<import("@segment/analytics-core").CoreContext<import("@segment/analytics-core").CoreSegmentEvent>> | null | undefined, options?: import("../events").Options | import("@segment/analytics-core").Callback<import("@segment/analytics-core").CoreContext<import("@segment/analytics-core").CoreSegmentEvent>> | undefined, callback?: import("@segment/analytics-core").Callback<import("@segment/analytics-core").CoreContext<import("@segment/analytics-core").CoreSegmentEvent>> | undefined) => Promise<Context>;
    register: (...args: import("../plugin").Plugin[]) => Promise<Context>;
    deregister: (...args: string[]) => Promise<Context>;
    user: () => Promise<import("../user").User>;
    readonly VERSION = "1.78.0";
